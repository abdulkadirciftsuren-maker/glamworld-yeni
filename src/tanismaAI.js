...
// ── DİL: Tanış sayfasının TÜM Türkçe metinleri (etiketler + karakter tanıtımları) ──
// Başka dildeki kullanıcı açınca bunlar yapay zekâ ile BİR KEZ çevrilip cihaza kaydedilir
// (i18n'e eklenir → mevcut t(anahtar) çağrıları otomatik çeviriyi gösterir). Türkçe hiç değişmez.
export const TANISMA_METINLER = {
  tanisBaslik: "Tanış",
  ...
  tanisFotoHaz: "fotoğraf hazırlanıyor…",
  uzaginda: "uzağında",
