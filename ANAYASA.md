...
> **⛔ YAZI DÜĞMEDE KESİLMEZ — SIĞMIYORSA KAYAR (kullanıcı KESİN, 2026-07-11, HER YERDE):** Hiçbir düğme/etikette yazı `…` ile kesilmez veya taşmaz. Sığmıyorsa yazı **şeritte SOLA doğru canlı yürür, 3 kez gidip başa döner, sonra BAŞTA durur** (`<KayanYazi>` bileşeni + `.kayan-dis/.kayan-ic` CSS). Ayarlar, Gloxoo, akış, hikâye, Reels — HER YENİ düğme/etikette uygulanır. Ayrıca **yazısız düğme**ye basılınca üstünde ne işe yaradığı görünmeli. Kullanıcı: "Nerede düğme varsa bak, yazı sığmıyorsa yürüsün, kesik olmasın; bundan sonra da hep böyle olacak."
>
> **⛔ SİYAH ZEMİN YASAK (kullanıcı KESİN, 2026-07-10):** HİÇBİR YERDE siyah/çok koyu zemin kullanılmaz. Tam ekran foto/video/hikâye açılışı, yükleme beklerken, kenar boşlukları (letterbox) — HER YER **parlak ALTIN/renkli** olur. Kodda siyah/koyu zemin (`#000`, `#0a1430`, `#05070e`, koyu radial vb.) görülürse ALTINA çevrilir. Kullanıcı: "Ben hiçbir yerde siyah görmek istemiyorum; sayfam renkli, canlı, düzgün, zarif olacak; medya yüklenene kadar bile altın kalsın."
>
