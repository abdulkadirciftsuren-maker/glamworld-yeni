/* GROXORG servis çalışanı — bildirim göstermek için (Android Chrome new Notification() desteklemez,
...
self.addEventListener("push", (e) => {
  let veri = {};
  try { veri = e.data ? e.data.json() : {}; } catch (x) { veri = { title: "GROXORG", body: e.data && e.data.text() }; }
  const baslik = veri.title || "GROXORG";
